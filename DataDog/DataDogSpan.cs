...
public class DataDogSpan : TuneSpan, IScope, ITuneSpan {

  private bool _disposed;

  public DataDogSpan(ITuneContext context, bool useParent = true, string? resource = null, string? action = null) : base(context) {
  ...
  public override void SetSession(ITuneSession session) {
