...
public class DataDogMetrics : LogicBase, ITuneMetrics {
  ...
  private DogStatsdService Metrics {
    get {
      ...
      if (Context.App.Env <= IZEnvironment.Development) cfg.StatsdServerName = "10.0.0.111";
      _metrics.Configure(cfg);
      return _metrics;
    }
  }

  public DataDogMetrics(ITuneContext context) : base(context) { }
