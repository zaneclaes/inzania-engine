...
public static class TimeStampData {
  ...
  public static TimeSpan TimeSinceCreated(this ICreatedAt ts) => ZEnv.Now - ts.CreatedAt;

  public static TimeSpan TimeSinceUpdated(this ITimeStampData ts) => ZEnv.Now - (ts.UpdatedAt ?? DateTime.UnixEpoch);
...
#pragma warning restore CS8073 // The result of the expression is always the same since a value of this type is never equal to 'null'
  ...
  public static void AutoIndex(ModelBuilder modelBuilder) {
    try {
      ...
      ZEnv.Log.Error(e, "[IDX] auto-indexing failed");
    }
  }
}
