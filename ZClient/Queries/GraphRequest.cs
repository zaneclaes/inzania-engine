...
public class GraphRequest {
  ...
  public string ToPayload() => ZJson.SerializeObject(this);

  public static object? FromPayload(IZContext context, Type expectedType, string? text, string? key = null) => null;
}
