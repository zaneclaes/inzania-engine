...
public class RootScope {
  public ITuneRootContext Context { get; }
  public IScope Scope { get; }

  public RootScope(ITuneRootContext context, IScope scope) {
    Context = context;
    Scope = scope;
  }
}
...
public static class ApiHttp {
  ...
  public static ITuneSpan ApiSpan(this HttpContext context, string operation, string name) {
  ...
  public static ITuneSpan AddRequestSpan(this HttpContext context, Type resource, string verb, bool useParent = true) => new DataDogSpan(context.RequestServices.GetCurrentContext(), useParent,
