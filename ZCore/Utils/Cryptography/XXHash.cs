...
public static class XXHash {
  ...
  public static uint Hash32(ReadOnlySpan<byte> buffer, uint seed = 0) {
    ...
    (uint acc1, uint acc2, uint acc3, uint acc4) = initAccumulators32(seed);
    do {
  ...
  public static uint Hash32(Stream stream, uint seed = 0) {
    ...
    Span<byte> buffer = new byte[readBufferSize].AsSpan();
    uint acc;
  ...
  public static ulong Hash64(ReadOnlySpan<byte> buffer, ulong seed = 0) {
    ...
    (ulong acc1, ulong acc2, ulong acc3, ulong acc4) = initAccumulators64(seed);
    do {
      int end = offset + stripeLength;
  ...
  private static (ulong Acc1, ulong Acc2, ulong Acc3, ulong Acc4) initAccumulators64(ulong seed) => (seed + prime64v1 + prime64v2, seed + prime64v2, seed, seed - prime64v1);
  ...
  private static (uint Acc1, uint Acc2, uint Acc3, uint Acc4) initAccumulators32(
    uint seed) => (seed + prime32v1 + prime32v2, seed + prime32v2, seed, seed - prime32v1);
