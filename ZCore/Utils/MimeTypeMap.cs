...
public static class MimeTypeMap {
  ...
  private static IDictionary<string, string> BuildMappings() {
    ...
    List<KeyValuePair<string, string>>? cache = mappings.ToList(); // need ToList() to avoid modifying while still enumerating
