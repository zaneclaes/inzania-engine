...
///     can be used instead for single-property keys, in which case the behavior is identical. If both attributes are used,
///     then
...
public sealed class ApiKeyAttribute : Attribute {
  ...
  public ApiKeyAttribute(string propertyName, params string[] additionalPropertyNames) {
